...
async function main() {
  ...
  // 4a) Lig maçlarına form-bazlı analiz (upcoming/live). Rate-limit için üst sınır.
  ...
  // 4b) Dünya Kupası maçlarına FIFA sıralaması bazlı analiz (API çağrısı YOK — anında).
  //     Milli takım form verisi ücretsiz tier'da olmadığı için sıralama kullanılır.
